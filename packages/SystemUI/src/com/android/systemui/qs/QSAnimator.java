    ...
    private void updateAnimators() {
        ...
        if (mQsPanelController.areThereTiles()) {
            for (QSTile tile : tiles) {
                ...
                int visibleTileCount = isRoundQS(view.getContext()) ?
                ...
                if (count < visibleTileCount) {
                    ...
                    // Icons
                    translateContent(
                            isRoundQS(quickTileView.getContext()) ? quickTileView.getIconWithBackground() : quickTileView.getIcon(),
                            isRoundQS(quickTileView.getContext()) ? tileView.getIconWithBackground() : tileView.getIcon(),
                            view,
                            xOffset,
                            yOffset,
                            mTmpLoc1,
                    ...
                    quadraticInterpolatorBuilder
                            .addFloat(isRoundQS(quickTileView.getContext()) ? quickTileView.getLabelContainer() : quickTileView.getSecondaryLabel(), "alpha", 0, 1);
                    nonFirstPageAlphaBuilder
                            .addFloat(isRoundQS(quickTileView.getContext()) ? quickTileView.getLabelContainer() : quickTileView.getSecondaryLabel(), "alpha", 0, 0);

                    mAnimatedQsViews.add(tileView);
                    mAllViews.add(quickTileView);
                    mAllViews.add(isRoundQS(quickTileView.getContext()) ? quickTileView.getLabelContainer() : quickTileView.getSecondaryLabel());
                    ...
                    firstPageBuilder.addFloat(isRoundQS(tileView.getContext()) ? tileView.getLabelContainer() : tileView.getSecondaryLabel(), "alpha", 0, 1);
                    mAllViews.add(isRoundQS(tileView.getContext()) ? tileView.getLabelContainer() : tileView.getSecondaryLabel());
                }
