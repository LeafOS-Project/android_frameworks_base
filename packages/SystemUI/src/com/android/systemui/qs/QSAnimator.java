...
import static com.android.internal.util.systemui.qs.QSStyleUtils.QS_STYLE_ROUND;
...
public class QSAnimator implements QSHost.Callback, PagedTileLayout.PageListener,
    ...
    public QSAnimator(QS qs, QuickQSPanel quickPanel, QuickStatusBarHeader quickStatusBarHeader,
        ...
        mIsRoundQS = mTunerService.getValue(QSPanel.QS_STYLE_ROUND, 1) == 1;
    }
        ...
        if (mQsPanelController.areThereTiles()) {
            for (QSTile tile : tiles) {
                ...
                if (count < mQuickQSPanelController.getTileLayout().getNumVisibleTiles()) {
                    ...
                    // Icons
                    translateContent(
                            mIsRoundQS ? quickTileView.getIconWithBackground() : quickTileView.getIcon(),
                            mIsRoundQS ? tileView.getIconWithBackground() : tileView.getIcon(),
                            view,
                            xOffset,
                            yOffset,
                            mTmpLoc1,
                    ...
                    quadraticInterpolatorBuilder
                            .addFloat(mIsRoundQS ? quickTileView.getLabelContainer() : quickTileView.getSecondaryLabel(), "alpha", 0, 1);
                    nonFirstPageAlphaBuilder
                            .addFloat(mIsRoundQS ? quickTileView.getLabelContainer() : quickTileView.getSecondaryLabel(), "alpha", 0, 0);

                    mAnimatedQsViews.add(tileView);
                    mAllViews.add(quickTileView);
                    mAllViews.add(mIsRoundQS ? quickTileView.getLabelContainer() : quickTileView.getSecondaryLabel());
                    ...
                    firstPageBuilder.addFloat(mIsRoundQS ? tileView.getLabelContainer() : tileView.getSecondaryLabel(), "alpha", 0, 1);
                    mAllViews.add(mIsRoundQS ? tileView.getLabelContainer() : tileView.getSecondaryLabel());
                }
