...
public final class AttestationHooks {
    ...
    public static void patchBuildFp(String algorithm) {
        Log.i(TAG, "Get service - algorithm=" + algorithm);
        if (sIsGms && "AndroidCAStore".equals(algorithm)) {
            String originalFp = Build.FINGERPRINT;
            Log.i(TAG, "Patch build for CAStore " + originalFp + " -> " + FAKE_FINGERPRINT);
            ...
            Thread thread = new Thread(() -> {
                try {
                    ...
                    Log.i(TAG,
                            "Unpatch build for CAStore " + FAKE_FINGERPRINT + " -> " + originalFp);
